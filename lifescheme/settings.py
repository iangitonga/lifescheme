"""
Django settings for lifescheme project.
...
WSGI_APPLICATION = 'lifescheme.wsgi.application'
...
DEFAULT_FROM_MAIL = os.environ.get('LIFESCHEME_EMAIL_HOST_USER')
